                ...
                <div className="relative z-10 w-full md:w-1/3 max-w-[400px] mx-auto">
                    ...
                    <div className="absolute top-0 left-0 p-4 sm:p-6 text-white w-ful">
                        <div className="mb-4">
                            ...
                            <p className="mt-[90px] text-lg absolute top-[52px] right-[-140px] flex items-center">ETH <span className="text-lg ml-1">&#x25BC;</span></p>
                            <p className="absolute top-[25px] right-[-150px] bg-white text-black rounded px-2 text-lg md:text-base">$289.38m</p>
                        </div>
